...
public class MecanumDrive extends LinearOpMode {
    ...
    public void drive(double pow, double rfRev, double rbRev, double lfRev,double lbRev){
        ...
        telemetry.addData("5", "initial angle: " + (initAng));
        telemetry.update();
        ...
        while((Math.abs(rfPos) < Math.abs(rfTics)) || (Math.abs(rbPos) < Math.abs(rbTics))||
            ...
            if(Math.abs(rfPos) != Math.abs(rfTics)){
                rfDir = (double)(Math.abs(rfTics)-Math.abs(rfPos))/(Math.abs((Math.abs(rfTics)-Math.abs(rfPos))));
            ...
            if(Math.abs(rbPos) != Math.abs(rbTics)){
                rbDir = (double)(Math.abs(rbTics)-Math.abs(rbPos))/(Math.abs((Math.abs(rbTics)-Math.abs(rbPos))));
            ...
            if(Math.abs(lfPos) != Math.abs(lfTics)){
                lfDir = (double)(Math.abs(lfTics)-Math.abs(lfPos))/(Math.abs((Math.abs(lfTics)-Math.abs(lfPos))));
            ...
            if(Math.abs(lbPos) != Math.abs(lbTics)){
                lbDir = (double)(Math.abs(lbTics)-Math.abs(lbPos))/(Math.abs((Math.abs(lbTics)-Math.abs(lbPos))));
            ...
            telemetry.addData("1", "motorRightFront: " + String.format("%d", rightFront.getCurrentPosition())
                    + " target: " + String.format("%d", rfTics)
                    + " power: " + (Math.round(rfScalPow*100)/100.0));
            telemetry.addData("2", "motorRightFront: " + String.format("%d", rightBack.getCurrentPosition())
                    + " target: "+String.format("%d", rbTics)
                    + " power: " + (Math.round(rbScalPow*100)/100.0));
            telemetry.addData("3", "motorRightFront: " + String.format("%d", leftFront.getCurrentPosition())
                    + " target: "+String.format("%d", lfTics)
                    + " power: " + (Math.round(lfScalPow*100)/100.0));
            telemetry.addData("4", "motorRightFront: " + String.format("%d", leftBack.getCurrentPosition())
                    + " target: "+String.format("%d", lbTics)
                    + " power: " + (Math.round(lbScalPow*100)/100.0));
            telemetry.addData("5", "initial angle: " + (initAng));
            telemetry.addData("6", "current angle: " + (curAng));
            telemetry.addData("7", "error: " + (error));
            telemetry.addData("8", "correction: " + (correction));
            telemetry.update();
        }
     ...
     * @param pow  the power at which the motors opperate
     */
    public void driveVector(double ang, double dist, double pow){
        ...
        */
        ...
        telemetry.addData("4", "motorRightFront: " + String.format("%d", leftBack.getCurrentPosition())
                + " target: "+String.format("%d", lbTics));
        telemetry.addData("5", "intial angle: " + (initAng));
        telemetry.update();
        ...
        while((Math.abs(rfPos) < Math.abs(rfTics)) || (Math.abs(rbPos) < Math.abs(rbTics))||
            ...
            if((Math.abs(rfPos) != Math.abs(rfTics))){
                rfScalPow = (double)(Math.abs(rfTics)-Math.abs(rfPos))/(Math.abs((Math.abs(rfTics)-Math.abs(rfPos)))) *
                        (Range.clip(rfPow*((double)Math.abs(rfTics)-(double)(Math.abs(rfPos))/(double)Math.abs(rfTics)),-pow,pow)-correction);
            }else{ rfScalPow = 0.0; }

            if((Math.abs(rbPos) != Math.abs(rbTics))){
                rbScalPow = (double)(Math.abs(rbTics)-Math.abs(rbPos))/(Math.abs((Math.abs(rbTics)-Math.abs(rbPos)))) *
                        (Range.clip(rbPow*((double)Math.abs(rbTics)-(double)(Math.abs(rbPos))/(double)Math.abs(rbTics)),-pow,pow)-correction);
            }else{ rbScalPow = 0.0; }

            if((Math.abs(lfPos) != Math.abs(lfTics))){
                lfScalPow = (double)(Math.abs(lfTics)-Math.abs(lfPos))/(Math.abs((Math.abs(lfTics)-Math.abs(lfPos)))) *
                        (Range.clip(lfPow*((double)Math.abs(lfTics)-(double)(Math.abs(lfPos))/(double)Math.abs(lfTics)),-pow,pow)-correction);
            }else{ lfScalPow = 0.0; }

            if((Math.abs(lbPos) != Math.abs(lbTics))){
                lbScalPow = (double)(Math.abs(lbTics)-Math.abs(lbPos))/(Math.abs((Math.abs(lbTics)-Math.abs(lbPos)))) *
            ...
            telemetry.addData("1", "motorRightFront: " + String.format("%d", rightFront.getCurrentPosition())
                    + " target: " + String.format("%d", rfTics)
                    + " power: " + (Math.round(rfScalPow*100)/100.0)
                    + " raw power: " + (Math.round(rfPow*100)/100.0));
            telemetry.addData("2", "motorRightFront: " + String.format("%d", rightBack.getCurrentPosition())
                    + " target: "+String.format("%d", rbTics)
                    + " power: " + (Math.round(rbScalPow*100)/100.0)
                    + " raw power: " + (Math.round(rbPow*100)/100.0));
            telemetry.addData("3", "motorRightFront: " + String.format("%d", leftFront.getCurrentPosition())
                    + " target: "+String.format("%d", lfTics)
                    + " power: " + (Math.round(lfScalPow*100)/100.0)
                    + " raw power: " + (Math.round(lfPow*100)/100.0));
            telemetry.addData("4", "motorRightFront: " + String.format("%d", leftBack.getCurrentPosition())
                    + " target: "+String.format("%d", lbTics)
                    + " power: " + (Math.round(lbScalPow*100)/100.0)
                    + " raw power: " + (Math.round(lbPow*100)/100.0));
            telemetry.addData("5", "intial angle: " + (initAng) + "current angle: " + (curAng));
            telemetry.addData("5", "intial angle: " + (initAng) + "current angle: " + (curAng));
            telemetry.addData("6", "error: " + (error));
            telemetry.addData("7", "correction: " + (correction));
            telemetry.update();
        }
        //need to reset the mode of the motors so that it can work with other methods such as powDrive
        rightFront.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
