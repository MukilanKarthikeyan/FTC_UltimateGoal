...
public class TRDrive {
    ...
    * NOTE: three wheel turns are not possible with the TileRunner*/
    ...
    public TRDrive (LinearOpMode mode){
        ...
        right_FrontM.setDirection(DcMotor.Direction.REVERSE);
        right_BackM.setDirection(DcMotor.Direction.REVERSE);
        left_FrontM.setDirection(DcMotor.Direction.FORWARD);
        left_BackM.setDirection(DcMotor.Direction.FORWARD);
